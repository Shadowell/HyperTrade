...
ROLE_CATALOG: dict[str, RoleDefinition] = {
    ...
    "data_quality": RoleDefinition(
        ...
        True,
        RoleBudget(max_tool_calls=3, max_tokens=20_000),
    ...
    "market_regime": RoleDefinition(
        ...
        True,
        RoleBudget(max_tool_calls=3, max_tokens=24_000),
    ...
    "evidence_synthesis": RoleDefinition(
        ...
        _READ_EVIDENCE,
        True,
        RoleBudget(max_tool_calls=1, max_tokens=24_000),
    ...
    "bull_case": RoleDefinition(
        ...
        _READ_EVIDENCE,
        True,
        RoleBudget(max_tool_calls=1, max_tokens=20_000),
    ...
    "strategy_engineer": RoleDefinition(
        ...
        True,
        RoleBudget(max_tool_calls=2, max_tokens=24_000),
    ...
    "bitpro_validation": RoleDefinition(
        ...
        True,
        RoleBudget(max_tool_calls=3, max_tokens=20_000, timeout_seconds=120),
