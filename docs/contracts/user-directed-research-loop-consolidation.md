...
清单周期修复切片：只使用inventory显式配置及身份匹配dashboard周期，冲突/缺失为unknown；短周期来源保留原研究周期，市场相对基准另用同窗完整1h已闭合K线，按上一根close绑定起点/7日分界/终点。行情缺口、越窗或1000点上限显式回退，不改变预算、Paper、审批或生产scope。
